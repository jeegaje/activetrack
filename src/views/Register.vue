<template>
  ...
  <form @submit.prevent="register" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
    ...
    <div class="mb-4">
      ...
      <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" v-model="confirmPass" id="confirmPass" type="text" placeholder="Confirm Password">
    </div>
    ...
    <router-link :to="{ name: 'Login' }">Already have account? Login</router-link>
  </form>
  <button @click="register">asda</button>
...
export default {
  ...
  setup() {
    ...
    return {email, password, confirmPass, errorMsg, register};
  },
  methods:{
